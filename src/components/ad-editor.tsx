      ...
      >
        ...
        <div className="p-6 sm:p-8 bg-paper border border-line space-y-5">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <label className="px-5 py-2.5 border border-charcoal bg-charcoal text-background hover:bg-olive text-xs font-medium cursor-pointer inline-flex items-center gap-2 transition-colors">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 p-6 bg-paper border border-line">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              className="px-8 py-3.5 bg-charcoal text-background hover:bg-olive font-semibold text-xs rounded-none transition-colors disabled:opacity-50 inline-flex items-center gap-2"
